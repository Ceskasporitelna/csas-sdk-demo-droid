 ...
 * @since 09/06/16.
 */
public class JAccountWithIdStatementsListPage1Test extends TestCase {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader,
                new Callback<Response>() {
                    ...
                    public void success(Response response, Response response2) {
                        ...
                        mNetbankingJudgeClient.getAccountsResource().withId(accountId).getStatementsResource().list(parameters,
                                new CallbackWebApi<StatementsListResponse>() {
                                    ...
                                    public void success(StatementsListResponse statementsListResponse) {
                                        ...
                                        if (!assertEquals("06029392819b0197", statement.getId()))
                                            return;
                                        if (!assertEquals(Integer.valueOf(3), statement.getNumber()))
                                            return;
    ...
    public String getName() {
        return "JAccountWithIdStatementsListPage1Test";
    }
