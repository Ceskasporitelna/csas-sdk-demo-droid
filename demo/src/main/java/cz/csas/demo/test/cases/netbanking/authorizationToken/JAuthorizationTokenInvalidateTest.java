 ...
 * @since 09/06/16.
 */
public class JAuthorizationTokenInvalidateTest extends TestCase {
    ...
    public void run(TestCallback callback) {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader, new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                mNetbankingJudgeClient.getAuthorizationTokenResource().delete(new CallbackWebApi<WebApiEmptyResponse>() {
                    @Override
    ...
    public String getName() {
        return "JAuthorizationTokenInvalidateTest";
    }
