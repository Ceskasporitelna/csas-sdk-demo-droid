 ...
 * @since 09/06/16.
 */
public class BuildingsListTest extends TestCase {

    @Override
    public void run(TestCallback callback) {
        mTestCallback = callback;

        mNetbankingClient.getContractsResource().getBuildingsResource().list(null, new CallbackWebApi<BuildingsListResponse>() {
            @Override
