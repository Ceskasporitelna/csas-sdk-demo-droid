 ...
 * @since 09/06/16.
 */
public class JTacPaymentsDomesticCreateTest extends TestCase {
            ...
            public void success(Response response, Response response2) {
                ...
                mNetbankingJudgeClient.getOrdersResource().getPaymentsResource().getDomesticResource().create(request, new CallbackWebApi<DomesticPaymentCreateResponse>() {
                    ...
                    public void success(DomesticPaymentCreateResponse domesticPaymentCreateResponse) {
                        ...
                        if (!assertEquals("1247657808", payment.getId()))
                            return;
                        ...
                        if (!assertEquals("18917bfb2990b3982662e09eb2ae7545eeb99104ca5505ca9281f16a275b1968", payment.signing().getSignId()))
                            return;
    ...
    public String getName() {
        return "JTacPaymentsDomesticCreateTest";
    }
        ...
        signingObject.getInfo(new CallbackWebApi<FilledSigningObject>() {
            ...
            public void success(FilledSigningObject filledSigningObject) {
                ...
                if (!assertEquals(SigningState.OPEN, filledSigningObject.getSigningState()))
                    return;
                if (!assertEquals("18917bfb2990b3982662e09eb2ae7545eeb99104ca5505ca9281f16a275b1968", filledSigningObject.getSignId()))
                    return;
    ...
    private void callSigningPUT(TacSigningProcess tacSigningProcess) {
        tacSigningProcess.finishSigning("00000000", new CallbackWebApi<SigningObject>() {
            ...
            public void success(SigningObject signingObject) {
                if (!assertEquals("18917bfb2990b3982662e09eb2ae7545eeb99104ca5505ca9281f16a275b1968", signingObject.getSignId()))
                    return;
