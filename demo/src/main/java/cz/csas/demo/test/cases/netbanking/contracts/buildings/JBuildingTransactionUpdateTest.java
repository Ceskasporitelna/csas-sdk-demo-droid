 ...
 * @since 09/06/16.
 */
public class JBuildingTransactionUpdateTest extends TestCase {
    ...
    public void run(TestCallback callback) {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader, new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                final String transactionId = "JHJKLASDHKALD12321";
                ...
                mNetbankingJudgeClient.getContractsResource().getBuildingsResource().withId(buildingId)
    ...
    public String getName() {
        return "JBuildingTransactionUpdateTest";
    }
