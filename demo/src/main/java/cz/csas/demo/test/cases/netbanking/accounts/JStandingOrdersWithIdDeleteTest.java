 ...
 * @since 09/06/16.
 */
public class JStandingOrdersWithIdDeleteTest extends TestCase {
                ...
                mNetbankingJudgeClient.getAccountsResource().withId(accountId).getStandingOrdersResource()
                    ...
                    public void success(StandingOrderResponse standingOrder) {
                        ...
                        if (!assertEquals(SigningState.OPEN, order.signing().getSigningState()))
                            return;
                        if (!assertEquals("160526104016300", order.signing().getSignId()))
                            return;
    ...
    public String getName() {
        return "JStandingOrdersWithIdDeleteTest";
    }
