 ...
 * @since 09/06/16.
 */
public class JBuildingTransactionsExportTest extends TestCase {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader, new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                ExportTransactionsParameters parameters = new ExportTransactionsParameters.Builder()
                        ...
                        .build();
                mNetbankingJudgeClient.getContractsResource().getBuildingsResource().withId(buildingId).getTransactionsResource()
    ...
    public String getName() {
        return "JBuildingTransactionsExportTest";
    }
