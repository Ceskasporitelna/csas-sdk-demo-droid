 ...
 * @since 09/06/16.
 */
public class StandingOrdersListPage1Test extends TestCase {

    @Override
    public void run(TestCallback callback) {
        mTestCallback = callback;

        StandingOrdersParameters parameters = new StandingOrdersParameters(new Pagination(1, 2), null);
    ...
    public String getName() {
        return "StandingOrdersListPage1Test";
    }
