 ...
 * @since 09/06/16.
 */
public class JAccountWithIdStatementsDownloadTest extends TestCase {
    ...
    public void run(TestCallback callback) {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader, new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                mNetbankingJudgeClient.getAccountsResource().withId(accountId).getStatementsResource().download(parameters, new CallbackWebApi<WebApiStream>() {
                    @Override
    ...
    public String getName() {
        return "JAccountWithIdStatementsDownloadTest";
    }
