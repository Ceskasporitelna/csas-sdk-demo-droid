 ...
 * @since 09/06/16.
 */
public class InsurancesListPage0Test extends TestCase {

    @Override
    public void run(TestCallback callback) {
        mTestCallback = callback;

        mNetbankingClient.getContractsResource().getInsurancesResource().list(new PaginatedParameters(new Pagination(0, 1)), new CallbackWebApi<InsuranceListResponse>() {
            @Override
    ...
    public String getName() {
        return "InsurancesListPage0Test";
    }
