 ...
 * @since 09/06/16.
 */
public class AccountWithIdStatementsListTest extends TestCase {
    ...
    public void run(TestCallback callback) {
        ...
        mNetbankingClient.getAccountsResource().withId("4B2F9EBE742BCAE1E98A78E12F6FBC62464A74EE").getStatementsResource().list(parameters, new CallbackWebApi<StatementsListResponse>() {
            @Override
    ...
    public String getName() {
        return "AccountWithIdStatementsListTest";
    }
