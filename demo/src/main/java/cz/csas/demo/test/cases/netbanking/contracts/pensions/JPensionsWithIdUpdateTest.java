...
import cz.csas.netbanking.contracts.pensions.PensionUpdateRequest;
import cz.csas.netbanking.contracts.pensions.PensionUpdateResponse;

/**
 * @author Jan Hauser <jan.hauser@applifting.cz>
 * @since 09/06/16.
 */
public class JPensionsWithIdUpdateTest extends TestCase {
    ...
    public void run(TestCallback callback) {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader, new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                mNetbankingJudgeClient.getContractsResource().getPensionsResource().withId(id).update(request, new CallbackWebApi<PensionUpdateResponse>() {
                    @Override
                    public void success(PensionUpdateResponse pension) {
                        ...
                        if (!assertEquals("CZK", pension.getPaidBenefits().getCurrency()))
                            return;
                        if (!assertEquals("test alias", pension.getAlias()))
                            return;
    ...
    public String getName() {
        return "JPensionsWithIdUpdateTest";
    }
