 ...
 * @since 09/06/16.
 */
public class JAccountWithIdTransactionsExportTest extends TestCase {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader,
                new Callback<Response>() {
                    ...
                    public void success(Response response, Response response2) {
                        ...
                        mNetbankingJudgeClient.getAccountsResource().withId(accountId).getTransactionsResource().getExportResource()
    ...
    public String getName() {
        return "JAccountWithIdTransactionsExportTest";
    }
