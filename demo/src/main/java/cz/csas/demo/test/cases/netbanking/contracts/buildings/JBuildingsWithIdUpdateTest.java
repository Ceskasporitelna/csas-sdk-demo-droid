...
import cz.csas.netbanking.contracts.buildings.BuildingsContractUpdateRequest;
import cz.csas.netbanking.contracts.buildings.BuildingsContractUpdateResponse;

/**
 * @author Jan Hauser <jan.hauser@applifting.cz>
 * @since 09/06/16.
 */
public class JBuildingsWithIdUpdateTest extends TestCase {
    ...
    public void run(TestCallback callback) {
        ...
        ((JudgeRestService) mJudgeClient.getService()).nextCase(X_JUDGE_CASE, mXJudgeSessionHeader, new Callback<Response>() {
            ...
            public void success(Response response, Response response2) {
                ...
                mNetbankingJudgeClient.getContractsResource().getBuildingsResource().withId(id).update(request, new CallbackWebApi<BuildingsContractUpdateResponse>() {
                    @Override
                    public void success(BuildingsContractUpdateResponse building) {
                        ...
                        if (!assertEquals("BCEF6B001FAE755D163A6CC9475E9FDFD9CD4A79", building.getId()))
                            return;
                        if (!assertEquals("test alias", building.getAlias()))
                            return;
                        ...
                        if (!assertEquals(SigningState.NONE, building.signing().getSigningState()))
                            return;
    ...
    public String getName() {
        return "JBuildingsWithIdUpdateTest";
    }
