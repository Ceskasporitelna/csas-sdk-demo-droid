 ...
 * @since 09/06/16.
 */
public class JCardAccountsStatementsListPage1Test extends TestCase {
            ...
            public void success(Response response, Response response2) {
                ...
                mNetbankingJudgeClient.getCardsResource().withId(cardId).getAccountsResource().withId(accountId)
                    ...
                    public void success(StatementsListResponse statementsListResponse) {
                        ...
                        if (!assertEquals("96029392819b0198", statement.getId()))
                            return;
                        if (!assertEquals(Integer.valueOf(8), statement.getNumber()))
                            return;
                        ...
                        if (!assertEquals(Language.CS, statement.getLanguage()))
                            return;
                        if (!assertEquals(TimeUtils.getISO8601Date("2016-01-29T00:00:00+01:00"), statement.getStatementDate()))
                            return;
    ...
    public String getName() {
        return "JCardAccountsStatementsListPage1Test";
    }
