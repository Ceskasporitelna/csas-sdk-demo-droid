 ...
 * @since 09/06/16.
 */
public class JAccountWithIdStatementsListPage0Test extends TestCase {
                                ...
                                new CallbackWebApi<StatementsListResponse>() {
                                    ...
                                    public void success(StatementsListResponse statementsListResponse) {
                                        if (!assertEquals(Long.valueOf(0), statementsListResponse.getPageNumber()))
                                            return;
                                        if (!assertEquals(Long.valueOf(1), statementsListResponse.getPageCount()))
                                            return;
    ...
    public String getName() {
        return "JAccountWithIdStatementsListPage0Test";
    }
