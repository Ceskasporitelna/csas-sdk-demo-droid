 ...
 * @since 09/06/16.
 */
public class MessagesListPage1Test extends TestCase {

    @Override
    public void run(TestCallback callback) {
        mTestCallback = callback;

        mNetbankingClient.getMessagesResource().list(new MessagesParameters(new Pagination(1, 1), null), new CallbackWebApi<MessagesListResponse>() {
            @Override
